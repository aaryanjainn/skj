                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">SKJ Admin Portal</h1>
                                    </div>
                                    <form class="user" method="post" action="<?php echo base_url();?>loginchecker">
                                    <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                        <div class="form-group">
                                            <input type="number" name="number" class="form-control form-control-user" placeholder="Number">
                                            <?php 
                                                if(form_error('number'))
                                                { 
                                            ?>
                                                    <span class="text-secondary text-center"><em><?php echo form_error('number');?></em></span>
                                            <?php 
                                                }
                                            ?>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <?php if(form_error('password')){ ?><span class="text-secondary text-center"><em><?php echo form_error('password');?></em></span><?php }?>
                                        </div>
                                        <!-- <div class="form-group">
